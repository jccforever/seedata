<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"E:\seedata\public/../application/index\view\express\adds.html";i:1548151900;s:53:"E:\seedata\application\index\view\layout\default.html";i:1552545932;s:50:"E:\seedata\application\index\view\common\meta.html";i:1548127895;s:53:"E:\seedata\application\index\view\common\sidenav.html";i:1555730106;s:52:"E:\seedata\application\index\view\common\script.html";i:1550733086;}*/ ?>
<!DOCTYPE html>
 <html>
        <head>
            <meta charset="utf-8">
    ...
    <ul class="sidebar-nav">
        ...
        <li class="sidebar-nav-link">
            <a href="javascript:;" class="sidebar-nav-sub-title">
                ...
                <?php if(in_array((\think\Request::instance()->action()), explode(',',"invite_list,money_log,recharge,changepwd"))): ?>
				...
				<div class="widget am-cf">
					<div class="widget-head am-fr">
						<div class="widget-title am-fl">
							<?php if($site['wangwang'] == '0'): ?>
							请联系客服审核地址后在发布单号！
							<?php else: ?>
							请用您的店铺旺旺发送平台的用户名给【<a target="_blank" href="http://www.taobao.com/webww/ww.php?ver=3&touid=<?php echo $site['wangwang']; ?>&siteid=cntaobao&status=1&charset=utf-8" ><img border="0" src="http://amos.alicdn.com/online.aw?v=2&uid=<?php echo $site['wangwang']; ?>&site=cntaobao&s=1&charset=utf-8" alt="点击认证" /></a>】<?php echo $site['wangwang']; ?> 旺旺审核！
							<?php endif; ?>
						</div>
					</div>
					<div class="widget-body am-fr">
						<div id="toolbar" class="toolbar">
							...
							<a href="javascript:;" class="btn btn-success btn-add" data-area='["800px","470px"]' title="<?php echo __('Add'); ?>" ><i class="fa fa-plus"></i> <?php echo __('Add'); ?></a>
						</div>
