<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"E:\seedata\public/../application/index\view\business\contend.html";i:1555557777;s:53:"E:\seedata\application\index\view\layout\default.html";i:1552545932;s:50:"E:\seedata\application\index\view\common\meta.html";i:1548127895;s:53:"E:\seedata\application\index\view\common\sidenav.html";i:1555741324;s:52:"E:\seedata\application\index\view\common\script.html";i:1550733086;}*/ ?>
<!DOCTYPE html>
 <html>
        <head>
            <meta charset="utf-8">
    ...
    <div class="dialog-body am-fr">
      <div class="am-form-group cgroup am-fl">
        ...
        <div class="am-u-sm-10">
          <input type="text" id="jpurl"  class="am-tagsinput" placeholder="输入商品链接或者商品SKU">
        </div>
      </div>
      <div class="am-form-group cgroup am-fl">
        <label class="am-u-sm-2 am-form-label" >备注:</label>
        <div class="am-u-sm-10">
          <input type="text" id="jptip"  class="am-tagsinput" placeholder="监控备注,方便管理识别是哪个商品">
        </div>
      </div>
      <div class="am-form-group digok am-fl">
        <label class="am-u-sm-2 am-form-label" ></label>
        <div class="am-u-sm-10">
          <button type="button" class="am-btn am-btn-primary am-radius" id="addjpbtn" onclick="addjpbtn()">提交
          </button>&nbsp;
