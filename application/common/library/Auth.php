...
class Auth
{
    ...
    public function refreshToken()
    {
		 Token::delete($this->_token);
		$this->_token = Random::uuid();
        return Token::set($this->_token,$this->_user->id,$this->keeptime);
		//return Db::table('fa_user_token')->where('user_id', $this->_user->id)->update(['token' => $this->_token]);
    }
    /**
     * 获取会员基本信息
     */
